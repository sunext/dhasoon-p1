...
struct thread
  {
    ...
    /* A new member introduced to track the total time a thread sleeps for.
     The thread will wake up exactly after wakeup_time.
    */
    int64_t wakeup_time;
...
bool is_thread_waking_now (const struct list_elem *a,
		const struct list_elem *b,
		void *aux UNUSED);

bool has_bigger_priority (const struct list_elem *a,
		   const struct list_elem *b,
		   void *aux UNUSED);
...
/*void insert_into_ready_list(struct thread *t);*/
